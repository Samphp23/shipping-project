...
def main():
    ...
    logging.info(f"Bronze_layer script completed in {elapsed_time:.2f} seconds")
    ...
    script_end_time = time.time() - script_start
    logging.info(f"Pipeline completed in {script_end_time:.2f} seconds")
